...
function LyteBox() {
	/*** Start Global Configuration ***/
		...
		this.navType			= 2;		// 1 = "Prev/Next" buttons on top left and left (default), 2 = "<< vorige | volgende >>" links next to image number
...
LyteBox.prototype.updateDetails = function() {
	...
	if (this.isSlideshow && this.slideArray.length > 1) {
		object.style.display = '';
		object.innerHTML = "Foto " + eval(this.activeSlide + 1) + " van " + this.slideArray.length;
		this.doc.getElementById('lbNavDisplay').style.display = (this.navType == 2 && this.showNavigation ? '' : 'none');
	} else if (this.imageArray.length > 1 && !this.isLyteframe) {
		object.style.display = '';
		object.innerHTML = "Foto " + eval(this.activeImage + 1) + " van " + this.imageArray.length;
